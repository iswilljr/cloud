// (<div style={{ zIndex: 9, top: 94, left: 356, position }}>
// 	<Image width={188} height={230} src="/avatar.png" alt="" />
// </div>
// div style={{ zIndex: 8, top: 150, left: 432, position }}>
// 	Image width={440} height={156} src="/boat.png" alt="" />
// /div>
// div style={{ zIndex: 7, top: 297, left: 371, position }}>
// 	Image width={166} height={49} src="/avatar-shadow.png" alt="" />
// /div>
// div style={{ zIndex: 6, top: 263, left: 442, position }}>
// 	Image width={430} height={75} src="/boat-shadow.png" alt="" />
// /div>
// div style={{ zIndex: 5, top: 73, left: 467, position }}>
// 	Image width={304} height={123} src="/1.png" alt="" />
// /div>
// div style={{ zIndex: 4, top: 113, left: 762, position }}>
